...
fullPath="$scriptsDir/dl-shopify-assets.sh"
# echo $fullPath

echo "==> downloading website files..."

wget -q https://raw.githubusercontent.com/thecoolagency/osx-bash-shopify-asset-downloader/main/dl-shopify-assets.sh
if [ $? != 0 ]
then
    echo " "
